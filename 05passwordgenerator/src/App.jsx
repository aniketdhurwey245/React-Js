...
function App() {
  ...
  // useCallback hooke is used because we need rerendering the method
  // useCallback(fn,dependencies) in place of dependency we pass [] array
  ...
  return (
    <>
      ...
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-400 bg-gray-800'>
        ...
        {/* div for placeholder bar or password bar */}
        ...
        {/* this div is for cursor-pointer */}
